...
const WAVEFORM_HEIGHTS = [
  6, 12, 20, 15, 24, 18, 9, 22, 28, 14, 20, 11, 25, 18, 7, 14, 21, 13, 17, 9,
];
...
const ContaminantCircle = ({ Icon, label, value }) => (
  ...
  >
    ...
    <span style={{ color: "#4b5563", fontSize: 10, textAlign: "center" }}>
      {value}
    </span>
  </div>
);
          ...
          >
                ...
                >
                  {[
                    ...
                    >
                      <Dot color={g.color} />
                      <span
                        style={{ color: "#4b5563", fontSize: 11, minWidth: 34 }}
                      >
                        {g.name}
                      </span>
                      <span
            ...
            <Panel title="Health Index">
              ...
              >
                ...
                >
                  <span
                    style={{ fontSize: 38, fontWeight: 900, lineHeight: 1 }}
                  >
                    5
                  </span>
                  <span
